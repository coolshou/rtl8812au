...
static struct usb_device_id rtw_usb_id_tbl[] = {
  ...
  {USB_DEVICE(0x2001, 0x3313), .driver_info = RTL8812}, /* D-Link DWA-182 B1- ALPHA */
  {USB_DEVICE(0x2001, 0x3315), .driver_info = RTL8812}, /* D-Link DWA-182 C1- Cameo */
  {USB_DEVICE(0x2001, 0x3316), .driver_info = RTL8812}, /* D-Link DWA-180 A1- Cameo */
